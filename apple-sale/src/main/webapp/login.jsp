...
<head>
	...
	<style>
		...
		*{margin:0;padding:0;box-sizing:border-box;}
		/* 设置背景图，字体设置为微软雅黑 */
		body{background: #ffe5c0;font-family: "微软雅黑", sans-serif;}
...
<div class="login">
	...
	<form action="login" method="post">
		<input type="text" name="aname" placeholder="用户名" required="required">
		<input type="password" name="apass" placeholder="密  码" required="required">
